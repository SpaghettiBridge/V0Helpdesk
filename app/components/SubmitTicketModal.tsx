...
export function SubmitTicketModal({ onCreateTicket }: SubmitTicketModalProps) {
  ...
  const handleSelectChange = (name: string, value: string) => {
    if (name === "mainCategory") {
      setTicketData((prev) => ({
        ...prev,
        mainCategory: value as TicketMainCategory,
        subCategory: "" as TicketSubCategory,
      }))
    } else {
      setTicketData((prev) => ({ ...prev, [name]: value }))
    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[600px]" align="top">
        <DialogHeader>
          ...
          <DialogDescription>Fill in the details to submit a new support ticket.</DialogDescription>
        </DialogHeader>
          ...
          <div className="grid gap-4 py-4">
            ...
            {ticketData.priority && (
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <div className="col-span-3 font-semibold">{ticketData.priority}</div>
              </div>
            )}
            <div className="grid grid-cols-4 items-center gap-4">
            ...
            {ticketData.mainCategory &&
              ["Bridgelink", "IT/System Support", "Training"].includes(ticketData.mainCategory) && (
                <div className="grid grid-cols-4 items-center gap-4">
                  ...
                  <Select onValueChange={(value) => handleSelectChange("subCategory", value)}>
                    ...
                    <SelectContent>{getSubCategories()}</SelectContent>
                  </Select>
                </div>
              )}
            <div className="grid grid-cols-4 items-center gap-4">
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <div className="col-span-3">
                <Input id="attachments" type="file" onChange={handleFileChange} multiple className="col-span-3" />
              </div>
            </div>
